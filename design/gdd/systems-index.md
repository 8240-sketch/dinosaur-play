...
| **inkgd Android APK** | Technical | inkgd v0.6.0 GDScript Ink runtime may have Android export issues unknown to LLM (post-4.3 knowledge cutoff) | **Week 1 end gate**: chapter1_minimal.ink P0 validation on real device. If fails → switch to custom JSON state machine (~150 GDScript lines), 1–2 days. |
